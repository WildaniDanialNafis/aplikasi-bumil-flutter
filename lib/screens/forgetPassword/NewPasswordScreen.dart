...
class _NewPasswordScreenState extends State<NewPasswordScreen> {
  ...
  Future<void> confirmValidation () async {
    if (_passwordController.text == _confirmPasswordController.text) {
      ...
      //     .showSnackBar(SnackBar(content: Text(_passwordController.text + ' ' + _confirmPasswordController.text)));
    } else {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Password Berbeda')));
    }
  }
  ...
  void _getMobileUser() async {
    ...
    await MobileUserController.updateMobileUser(idMobileUser, email, _passwordController.text);

    setState(() {
      isLoading = false;
    });

    CustomAlertDialog.showSuccessDialog(context, "Berhasil Mengubah Password", () {
      Navigator.push(
        context,
