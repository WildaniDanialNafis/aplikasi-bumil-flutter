...
class UpdateDataDiriScreen extends StatefulWidget {
  const UpdateDataDiriScreen({super.key});

  @override
  State<UpdateDataDiriScreen> createState() => _UpdateDataDiriScreenState();
}

class _UpdateDataDiriScreenState extends State<UpdateDataDiriScreen> {
  ...
  Future<void> _updateData() async {
    ...
    try {
      await DataDiriController.updateDataDiri(
        DataDiriController.dataDiri!.idDataDiri,
      ...
      CustomAlertDialog.showSuccessDialog(context, "Berhasil Mengubah Data Diri", () async {
  ...
  void initState() {
    super.initState();
    _initialize();
    _namaLengkapController.text = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.namaLengkap : '';
    _tempatLahirController.text = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.tempatLahir : '';
    sendTanggal = (DataDiriController.dataDiri != null) ? sendTanggalFormat(DataDiriController.dataDiri!.tanggaLahir) : '';
    _tanggalLahirController.text = (DataDiriController.dataDiri != null) ? tanggalLahirFormat(DataDiriController.dataDiri!.tanggaLahir) : '';
    _selectedGenderNotifier.value = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.jenisKelamin : '';
    _selectedProvinsiNotifier.value = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.provinsi : '';
    _selectedKabupatenNotifier.value = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.kabupaten : '';
    _alamatController.text = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.alamat : '';
    _nomorTeleponController.text = (DataDiriController.dataDiri != null) ? DataDiriController.dataDiri!.nomorTelepon : '';
  }
